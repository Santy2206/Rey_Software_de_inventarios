...
class bitacora_service: #clase principal de la bitacora a usar 
    def __init__(self, bitacora_repository): #constructor de la clase 
        self.bitacora_repository = bitacora_repository #se asigna el repositorio de la bitacora a la clase 

    def registrar_evento(self, evento): #metodo para registrar un evento en la bitacora 
        self.bitacora_repository.registrar_evento(evento) #se llama al metodo del repositorio para registrar el evento
        self.registros=[]
